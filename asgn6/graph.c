...
typedef struct graph {
    uint32_t vertices;
    bool directed;
    bool *visited; //memory location, pointer to array of vertice names / indexes
    char **names; // memory location, array of pointers, size = vertices * character pointer.
    uint32_t **weights; // memory location, array of pointers, this is the matrix
} Graph;
